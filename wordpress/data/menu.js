...
window.KS_MENU = [
  ...
  { name: "Ikan Bakar Kurnia",                 desc: "Ikan segar dibakar dengan bumbu spesial khas Kurnia.", signature: true,  isNew: false, image: "assets/menu-ikan-bakar-kurnia.jpg", placeholder: false },
  ...
  { name: "Udang Saus Kurnia",                 desc: "Udang segar berbalut saus khas Kurnia, gurih-manis.",   signature: true,  isNew: false, image: "assets/menu-udang-saus-kurnia.jpg", placeholder: false }, // nama kanonik
  { name: "Kepiting Saus Garlic Caramel",      desc: "Kepiting dengan karamel bawang putih yang harum.",      signature: true,  isNew: false, image: "assets/menu-kepiting-garlic-caramel.jpg", placeholder: false }, // nama kanonik
  { name: "King Crab Sultan",                  desc: "King crab premium dengan saus spesial khas Kurnia.",    signature: true,  isNew: false, image: "assets/menu-king-crab-sultan.jpg", placeholder: false }, // nama kanonik

  /* ---- NEW MENU (placeholder — TODO: isi menu baru asli dari tim) ---- */
  { name: "Rahang Tuna", desc: "Rahang tuna panggang, bumbu khas Kurnia.", isNew: true, signature: false, image: "assets/menu-baru-rahang-tuna.png", placeholder: false },
